...
// Note: Evaluation is int type for numeric comparison.
// JSON serialization outputs as integer.
type Evaluation int
...
// Predefined Evaluation constants.
const (
	// Bad scores (0~40)
...
// GetCategory returns the evaluation category (snake_case for JSON).
